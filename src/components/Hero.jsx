  ...
  return (
    <section id="home" className="container hero-sec sec--pad">
      ...
      <p className="hero-heading-sub">
        Web Developer @{" "}
        <a href="https://cooledtured.com/" target="_blank">
          <span className="solve-problems">Cooledtured Collections </span>
        </a>
      </p>
      <p className="hero-heading-sub">
        I<span className="solve-problems hero-heart"> &#x2764; </span>Front End
        Development
      </p>
      ...
      <div className="hero__socials">
        <div className="hero__social">
          <a href="https://www.linkedin.com/in/keron-williams/" target="_blank">
            <ion-icon class="hero-icon" name="logo-linkedin"></ion-icon>
          </a>
        </div>
        <div className="hero__social">
          <a href="https://github.com/ikeronx" target="_blank">
            <ion-icon class="hero-icon" name="logo-github"></ion-icon>
          </a>
        </div>
        <div className="hero__social">
          <a href="https://codepen.io/ikeronx" target="_blank">
            <ion-icon class="hero-icon" name="logo-codepen"></ion-icon>
          </a>
        </div>
      </div>
    </section>
