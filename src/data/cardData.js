export const data = [
    {
        ...
        description: `Trips Ahoy! is a travel companion app consuming multiple web APIs that allow users to perform CRUD operations to plan and organize trips and document the experience they had from a trip.
