export const data = [
    {
        ...
        description: `Trips Ahoy! is a travel companion app consuming multiple web APIs that allow users to plan and organize trips and document the experience they had from a trip. The key features of the app are, search an address or place, getting current weather for address searched, finding places near an area searched, find a route and directions, add trips by clicking on the map, rate trips, update trips, delete trips, look up flights and change map style.
